...
class MatchOneLayer(nn.Module):
    ...
    def forward(self, layer_weights):
        ...
        # pi_li_2 = self.softmax(self.pi_li)
        pi_li_2 = (self.pi_li ** 2) * 100
        # for _ in range(100):
        ...
        return post_loss, [loss, squared_col_diff, squared_row_diff], global_layer_weights, pi_li_2
...
def get_matched_weights(cur_weights, layer_idx, args, device, use_diff_match=False):
    ...
    if args.diff_match:
        ...
        optimizer = optim.Adam(match.parameters(), lr=args.lr*10)
        ...
        T_arr = [torch.eye(output_size).to(device)]
